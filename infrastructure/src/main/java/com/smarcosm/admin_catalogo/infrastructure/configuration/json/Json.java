package com.smarcosm.admin_catalogo.infrastructure.configuration.json;
...
import static org.aspectj.util.Reflection.invoke;
...
public enum Json {
    ...
    private AfterburnerModule afterburnerModule(){
        ...
        // without this, Java 9+ complains od "Illegal reflective access"
