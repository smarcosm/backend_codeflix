...
public interface MockDsl {
    ...
    default ResultActions updateACategory(final CategoryID anId, UpdateCategoryRequest aRequest) throws Exception {
    ...
    default ResultActions updateAGenre(final GenreID anId, UpdateGenreRequest aRequest) throws Exception {
    ...
    private ResultActions update(final String url, final Identifier anId, final Object aRequestBody) throws Exception {
        final var aRequest = MockMvcRequestBuilders.put(url + anId.getValue()).contentType(MediaType.APPLICATION_JSON).content(Json.writeValueAsString(aRequestBody));
